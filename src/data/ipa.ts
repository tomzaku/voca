...
export const IPA_SOUNDS: IpaSound[] = [
  // ── Short vowels ──
  { symbol: 'ɪ', category: 'vowel-short', examples: ['sit', 'pin', 'dish'], moreExamples: ['bit', 'kiss', 'lip', 'big'],
    howTo: 'Tongue high and toward the front, lips relaxed and slightly spread — shorter and looser than /iː/.' },
  { symbol: 'e', category: 'vowel-short', examples: ['bed', 'pen', 'red'], moreExamples: ['bell', 'ten', 'get', 'went'],
    howTo: 'Mouth half-open, tongue mid and forward, lips relaxed — like /ɪ/ but with the jaw dropped a little more.' },
  { symbol: 'æ', category: 'vowel-short', examples: ['cat', 'hat', 'bag'], moreExamples: ['bad', 'man', 'apple', 'black'],
    howTo: 'Jaw drops low, lips spread wide, tongue low and forward — the widest smile of the short vowels.' },
  { symbol: 'ʌ', category: 'vowel-short', examples: ['cup', 'run', 'luck'], moreExamples: ['love', 'mother', 'come', 'blood'],
    howTo: 'Mouth barely open, tongue central and relaxed, lips neutral — a short, clipped "uh".' },
  { symbol: 'ɒ', category: 'vowel-short', examples: ['hot', 'dog', 'top'], moreExamples: ['box', 'watch', 'shop', 'lot'],
    howTo: 'Lips rounded, jaw dropped, tongue low and back — the British "o" in "hot" (many American speakers merge this with /ɑː/).' },
  { symbol: 'ʊ', category: 'vowel-short', examples: ['book', 'put', 'foot'], moreExamples: ['good', 'look', 'wood', 'cook'],
    howTo: 'Lips loosely rounded, tongue high and back, short and relaxed — not as tense or rounded as /uː/.' },
  { symbol: 'ə', category: 'vowel-short', examples: ['about', 'sofa', 'banana'], moreExamples: ['doctor', 'upon', 'common', 'camera'],
  ...
  // ── Long vowels ──
  { symbol: 'iː', category: 'vowel-long', examples: ['see', 'tree', 'sheep'], moreExamples: ['three', 'key', 'cheese', 'please'],
    howTo: 'Lips spread into a tight smile, tongue high and forward, held longer and tenser than /ɪ/.' },
  { symbol: 'ɜː', category: 'vowel-long', examples: ['bird', 'girl', 'learn'], moreExamples: ['word', 'nurse', 'work', 'first'],
    howTo: 'Lips neutral, tongue mid-central, jaw slightly open — held long, like a British "er".' },
  { symbol: 'ɑː', category: 'vowel-long', examples: ['car', 'father', 'class'], moreExamples: ['park', 'heart', 'palm', 'dark'],
    howTo: 'Mouth wide open, tongue low and back, lips relaxed — a long, open "ah".' },
  { symbol: 'ɔː', category: 'vowel-long', examples: ['door', 'saw', 'ball'], moreExamples: ['more', 'walk', 'thought', 'sport'],
    howTo: 'Lips rounded and pushed forward, tongue mid-back, jaw dropped — held long.' },
  { symbol: 'uː', category: 'vowel-long', examples: ['blue', 'food', 'moon'], moreExamples: ['two', 'shoe', 'true', 'school'],
  ...
  { symbol: 'eɪ', category: 'diphthong', examples: ['day', 'name', 'rain'], moreExamples: ['play', 'wait', 'they', 'eight'],
    howTo: 'Starts at /e/ and glides up toward /ɪ/ — lips move from relaxed to slightly spread as you say it.' },
  { symbol: 'aɪ', category: 'diphthong', examples: ['my', 'time', 'light'], moreExamples: ['fly', 'night', 'buy', 'five'],
    howTo: 'Starts open and low, glides up toward /ɪ/ — the jaw closes as the sound finishes.' },
  { symbol: 'ɔɪ', category: 'diphthong', examples: ['boy', 'coin', 'noise'], moreExamples: ['toy', 'voice', 'join', 'enjoy'],
    howTo: 'Starts rounded like /ɔː/, glides toward /ɪ/ — the lips unround as the tongue rises.' },
  { symbol: 'aʊ', category: 'diphthong', examples: ['now', 'house', 'town'], moreExamples: ['cow', 'mouth', 'sound', 'out'],
    howTo: 'Starts open and low, glides toward /ʊ/ — the lips round as the sound closes.' },
  { symbol: 'əʊ', category: 'diphthong', examples: ['go', 'home', 'boat'], moreExamples: ['no', 'road', 'phone', 'know'],
    howTo: 'Starts central (schwa), glides toward /ʊ/ — the lips round only at the end.' },
  { symbol: 'ɪə', category: 'diphthong', examples: ['near', 'ear', 'here'], moreExamples: ['idea', 'beer', 'weird', 'clear'],
    howTo: 'Starts at /ɪ/, glides toward schwa — common before "r" in non-rhotic British English.' },
  { symbol: 'eə', category: 'diphthong', examples: ['hair', 'chair', 'care'], moreExamples: ['bear', 'where', 'fair', 'stairs'],
    howTo: 'Starts at /e/, glides toward schwa — the jaw opens slightly as it fades.' },
  { symbol: 'ʊə', category: 'diphthong', examples: ['pure', 'tour', 'sure'], moreExamples: ['cure', 'moor', 'endure'],
    howTo: 'Starts at /ʊ/, glides toward schwa — increasingly rare in modern speech, often replaced by /ɔː/.' },

  // ── Consonants ──
  { symbol: 'p', category: 'consonant', examples: ['pen', 'map', 'apple'], moreExamples: ['park', 'stop', 'paper', 'pepper'],
    howTo: 'Lips press together, then release with a puff of air — voiceless, no vibration in the throat.' },
  { symbol: 'b', category: 'consonant', examples: ['bad', 'cab', 'table'], moreExamples: ['boy', 'cab', 'rabbit', 'bubble'],
    howTo: 'Lips press together, then release — same spot as /p/ but with the vocal cords vibrating (voiced).' },
  { symbol: 't', category: 'consonant', examples: ['ten', 'sit', 'better'], moreExamples: ['top', 'cat', 'letter', 'tent'],
    howTo: 'Tongue tip taps the ridge behind your top teeth, then releases with a puff of air — voiceless.' },
  { symbol: 'd', category: 'consonant', examples: ['dog', 'red', 'ladder'], moreExamples: ['day', 'bed', 'ladder', 'dad'],
    howTo: 'Tongue tip taps the ridge behind your top teeth, then releases — same spot as /t/ but voiced.' },
  { symbol: 'k', category: 'consonant', examples: ['cat', 'sick', 'kitchen'], moreExamples: ['key', 'back', 'cookie', 'kick'],
    howTo: 'The back of the tongue touches the soft palate, then releases with a puff of air — voiceless.' },
  { symbol: 'g', category: 'consonant', examples: ['go', 'big', 'garden'], moreExamples: ['get', 'bag', 'giggle', 'dog'],
    howTo: 'The back of the tongue touches the soft palate, then releases — same spot as /k/ but voiced.' },
  { symbol: 'f', category: 'consonant', examples: ['fan', 'leaf', 'coffee'], moreExamples: ['fun', 'life', 'coffee', 'phone'],
    howTo: 'Top teeth rest lightly on the bottom lip, air pushes through the gap — voiceless.' },
  { symbol: 'v', category: 'consonant', examples: ['van', 'love', 'seven'], moreExamples: ['very', 'live', 'seven', 'view'],
    howTo: 'Top teeth rest lightly on the bottom lip, air pushes through — same as /f/ but voiced, felt as a buzz on the lip.' },
  { symbol: 'θ', category: 'consonant', examples: ['think', 'bath', 'three'], moreExamples: ['thumb', 'tooth', 'birthday', 'math'],
    howTo: 'Tongue tip pokes gently between the teeth, air hisses past it — voiceless, as in "think".' },
  { symbol: 'ð', category: 'consonant', examples: ['this', 'mother', 'weather'], moreExamples: ['that', 'brother', 'weather', 'smooth'],
    howTo: 'Tongue tip pokes gently between the teeth, air hisses past it — same spot as /θ/ but voiced, as in "this".' },
  { symbol: 's', category: 'consonant', examples: ['sun', 'bus', 'city'], moreExamples: ['see', 'bus', 'listen', 'sister'],
    howTo: 'Tongue tip near the ridge behind the teeth, a narrow channel hisses air out — voiceless.' },
  { symbol: 'z', category: 'consonant', examples: ['zoo', 'buzz', 'lazy'], moreExamples: ['zip', 'buzz', 'easy', 'music'],
    howTo: 'Same tongue position as /s/ — but voiced, felt as a buzz.' },
  { symbol: 'ʃ', category: 'consonant', examples: ['she', 'wash', 'sugar'], moreExamples: ['shop', 'wish', 'nation', 'sure'],
    howTo: 'Tongue pulled back a little further than /s/, lips slightly rounded — voiceless "sh".' },
  { symbol: 'ʒ', category: 'consonant', examples: ['vision', 'treasure', 'usual'], moreExamples: ['pleasure', 'measure', 'garage', 'decision'],
    howTo: 'Same tongue position as /ʃ/ — but voiced. Rare in English, and almost never at the start of a word.' },
  { symbol: 'h', category: 'consonant', examples: ['hat', 'house', 'ahead'], moreExamples: ['hello', 'home', 'behind', 'hope'],
    howTo: 'A light puff of breath from the throat, with no contact between tongue and mouth — voiceless.' },
  { symbol: 'tʃ', category: 'consonant', examples: ['chair', 'watch', 'teacher'], moreExamples: ['church', 'catch', 'cheese', 'kitchen'],
    howTo: 'A /t/ released straight into /ʃ/ in one quick motion — voiceless, as in "church".' },
  { symbol: 'dʒ', category: 'consonant', examples: ['jump', 'bridge', 'danger'], moreExamples: ['judge', 'age', 'giant', 'gym'],
    howTo: 'A /d/ released straight into /ʒ/ in one quick motion — voiced, as in "judge".' },
  { symbol: 'm', category: 'consonant', examples: ['man', 'summer', 'drum'], moreExamples: ['mum', 'summer', 'drum', 'animal'],
    howTo: 'Lips press together, air hums out through the nose — voiced.' },
  { symbol: 'n', category: 'consonant', examples: ['no', 'sun', 'dinner'], moreExamples: ['nine', 'dinner', 'sun', 'banana'],
    howTo: 'Tongue tip touches the ridge behind the teeth, air hums out through the nose — voiced.' },
  { symbol: 'ŋ', category: 'consonant', examples: ['sing', 'king', 'morning'], moreExamples: ['thing', 'long', 'singer', 'tongue'],
  ...
  { symbol: 'l', category: 'consonant', examples: ['leg', 'ball', 'yellow'], moreExamples: ['love', 'tell', 'yellow', 'apple'],
    howTo: 'Tongue tip touches the ridge behind the teeth, air flows around the sides of the tongue — voiced.' },
  { symbol: 'r', category: 'consonant', examples: ['red', 'carry', 'sorry'], moreExamples: ['run', 'very', 'sorry', 'road'],
    howTo: 'Tongue curls back slightly without touching the roof of the mouth — voiced, no trill in English.' },
  { symbol: 'j', category: 'consonant', examples: ['yes', 'yellow', 'use'], moreExamples: ['you', 'yellow', 'few', 'music'],
    howTo: 'Tongue high and forward like /iː/, then glides quickly into the next vowel — voiced, as in "yes".' },
  { symbol: 'w', category: 'consonant', examples: ['wet', 'away', 'swim'], moreExamples: ['window', 'sweet', 'quick', 'one'],
