...
function MemberRing({ m, size = 'w-9 h-9' }: { m: MemberProgress; size?: string }) {
  ...
  return (
    <div className="flex items-center gap-1.5 mt-2">
      ...
      {showAll && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-2xl border border-border bg-bg-card shadow-2xl p-5 max-h-[80vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
