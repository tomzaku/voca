// Translate and briefly explain an English word for a speaker of another
// language.
//
//   POST /ai-translate-word { word, targetLang } → { text }
//
...
//
// Deploy: `supabase functions deploy ai-translate-word`
